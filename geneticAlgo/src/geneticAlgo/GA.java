...
public class GA {
    ...
    Candidate newChild(Candidate c1, Candidate c2, int pivot) {
        ...
        for (int j = pivot; j < Candidate.npNbr; j++) {
    ...
    Candidate[] newChilds(Candidate c1, Candidate c2) {
    	Candidate child1 = new Candidate(c1.genotype[0].length);
        Candidate child2 = new Candidate(c2.genotype[0].length);
        
        for (int i = 0; i < Candidate.npNbr; i++) {
            ...
            if (b) {
                ...
                child2.genotype[i] = c2.genotype[i];
            	 ...
            	 child1 = new Candidate(c2.genotype[0].length);
                 child2 = new Candidate(c1.genotype[0].length);
    ...
    void mutate(Candidate c) {
        ...
        int i = rand.nextInt(c.genotype.length);
        int j = rand.nextInt(c.genotype[0].length);
        //System.out.println("i=" + i + " j=" +j);
        
        c.genotype[i][j] = !c.genotype[i][j]; // flip
    }
